    ...
    <div>
      <div className=" flex flex-col items-center gap-2 p-5  pb-0 pt-10">
        <div className="flex justify-evenly">
          <Image src={navnelogo_hvid} width={300} height={90} alt="Logo"></Image>
        </div>
        <div className="my-5">
          <Nyhedsbrev />
        </div>
        <div className="my-5 grid grid-flow-col">
          <div className="flex flex-col items-start gap-2">
            <h6 className="text-mobileH6 font-megettyk text-yellowbase md:text-wh6">Sider</h6>
          ...
          <div className="flex flex-col items-start gap-2">
            <h6 className="text-mobileH6 font-megettyk text-yellowbase md:text-wh6">Legal</h6>
        ...
        <div className="flex flex-col items-center gap-2">
          <h6 className="text-mobileH6 font-megettyk text-yellowbase">Plateau Spirits</h6>
        ...
        <div className="mt-5 flex flex-col items-center">
          ...
          <p className="font-copy text-copy text-yellowbase">© PLATEAU SPIRITS 2023</p>
        </div>
      </div>
    </div>
  );
