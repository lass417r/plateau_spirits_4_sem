      ...
      <div className=" flex flex-col items-center justify-between">
        <section className="z-10 flex w-full max-w-6xl flex-col-reverse items-center justify-between overflow-hidden p-6 md:mx-10 md:flex-row md:pt-10">
          <div className="flex flex-col  items-start gap-y-3">
            <h1 className="font-ssort text-mobileH1 text-black500 md:text-wh1">Small batch spiritus</h1>
            <h2 className="pb-4 font-ssort text-mobileH4 text-black500 md:text-wh4">Håndlavet i kødbyen København</h2>
        ...
        <section className="flex flex-col gap-5 p-6 pt-20 md:mx-20 md:flex-row">
          <div lassName="  flex basis-1/3 flex-col gap-3 flex-initial w-10">
        ...
        <section className="z-10 my-5 flex flex-col gap-10 p-6 md:mx-10 md:flex-row">
          <div className="relative flex basis-1/2 justify-end">
            ...
            <Image className="absolute md:left-[70%] md:top-[60%]" src={tilgang} width={400} height={400} alt="Illutrativt element"></Image>
          </div>
          <div className="basis-1/2">
            <h2 className="pb-2 font-ssort text-mobileH2 md:text-wh2">Vores tilgang </h2>
            <p className="font-copy text-copy lg:max-w-[80%]">
        ...
        <section className="bg-matte200  md:-mt-20">
          <div className=" my-10 p-6 md:mx-16 md:mb-20 md:mt-40">
            <h2 className="font-ssort text-titlebxs text-orangebase md:text-titlexl">Awards</h2>
