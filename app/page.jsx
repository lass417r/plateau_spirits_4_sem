      ...
      <div className=" flex min-h-screen flex-col items-center justify-between">
        <section className="z-10 ml-10 mr-10 flex w-full max-w-6xl items-center justify-between md:pt-20">
          <div className="flex flex-col items-start gap-y-3">
            ...
            <h2 className="pb-4 font-ssort text-wh4 text-black500">Håndlavet i kødbyen København</h2>
            <Button href={"/shop"} text={"Se produkter"}></Button>
          </div>
          <Image src={splash} width={500} height={500} alt="Flot billede af Gin flaske"></Image>
        </section>
        ...
        <section className="  ml-10 mr-10 flex gap-5  p-5 pt-20">
          <div lassName=" ml-20 flex basis-2/4 flex-col items-start gap-y-3">
            <h2 className=" font-ssort text-wh2">Udvalgte produkter</h2>
            ...
            {/* <ul className="list-disc font-ssort text-orangebase">
              <li>Håndlavet i københavn</li>
              <li>Limited bottles</li>
            </ul> */}
            <div className="pt-10">
              <Button href={"/shop"} text={"Se produkter"}></Button>
            </div>
          ...
          <div className="flex basis-1/4 flex-col gap-2">
            ...
            <h5 className="pt-4 text-wh5 font-normal">Roÿe Vodka</h5>
          ...
          <div className="flex basis-1/4 flex-col gap-2">
            ...
            <h5 className="pt-4 text-wh5 font-normal">Plateau Gin</h5>
        ...
        <section id="udvalgteprodukter" c className="relative w-full">
        ...
        <section className="z-10 ml-10 mr-10 flex flex-row gap-10 p-5">
          ...
          <div className="basis-1/2">
            <h2 className="pb-2 font-ssort text-wh2">Vores tilgang </h2>
            <p className="font-copy text-copy lg:max-w-[80%]">
