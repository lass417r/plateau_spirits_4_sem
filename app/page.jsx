...
export default function Home() {
  return (
    <>
      <div className="flex min-h-screen flex-col items-center justify-between p-5 ml-10 mr-10">
        ...
        <section className="pt-20 bg-matte200">
      ...
      <div className="pt-10 w-full my-10">
