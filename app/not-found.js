  ...
  return (
    <div className="mx-10 mt-5 flex h-auto w-auto flex-col items-center justify-start gap-16 md:mx-40 md:min-h-screen ">
      <div className="relative h-1/3 w-1/3">
        ...
        <Image className="absolute left-1/2 top-1/2 z-10 h-[65%] w-auto -translate-x-1/2 -translate-y-1/2 transform md:h-[70%]" src={logo} width={400} height={400} alt="logo plateau"></Image>
      </div>
