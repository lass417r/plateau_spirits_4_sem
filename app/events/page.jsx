      ...
      <section className="flex min-h-screen flex-col items-start justify-between md:mx-20 md:mb-20 md:flex-row">
        <div className="top-3 md:sticky md:basis-1/2">
          <div className="flex flex-col items-start gap-5 p-5">
            ...
            <a
              href="#KontaktEvents"
              className="voresKnap border-2 border-black400 bg-white100 px-5  py-3 font-ssort text-black400 md:text-deskButtonPrimary md:tracking-wider"
            >
              Book Event
            </a>
          </div>
        ...
        <div className="relative flex flex-col items-center gap-5 overflow-hidden p-5 pt-28 md:basis-1/2 md:overflow-visible">
          <Image
            className="absolute z-0 hidden md:mt-32 md:block "
            src={gitter}
            width={1500}
            height={3000}
      ...
      <section className="mb-10   flex flex-col items-start gap-20 p-5 md:mx-20 md:mb-20 md:flex-row">
        ...
        <div className="lg:max-w-[80%]">
          ...
          <p className="font-copy lg:max-w-[70%]">
            ...
            hvor vores produkter kan smages og udforskes af jer. Vi runder
            aftenen af med mad serveret fra en af restauranterne i Kødbyen.
          </p>
        </div>
      </section>
